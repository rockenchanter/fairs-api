...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['stall_id'], ['fair.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', 'company_id', 'fair_id')
    )
    op.alter_column('company', 'exhibitor_id',
               existing_type=sa.INTEGER(),
               nullable=False)
    op.alter_column('fair', 'organizer_id',
               existing_type=sa.INTEGER(),
               nullable=False)
    op.alter_column('fair', 'hall_id',
               existing_type=sa.INTEGER(),
               nullable=False)
    op.add_column('hall', sa.Column('size', sa.Float(), nullable=False))
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('hall', 'size')
    op.alter_column('fair', 'hall_id',
               existing_type=sa.INTEGER(),
               nullable=True)
    op.alter_column('fair', 'organizer_id',
