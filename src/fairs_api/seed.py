...
def create_user(role, name, surname, num):
    if role == "exhibitor":
        ...
        usr = md.Organizer(email=f"{name}@email.com", password=f"{name}1234",
...
users = {
    ...
    "exhibitor_1": create_user("exhibitor", "Gordon", "Ramsey", 6),
}
...
companies["sturmer"].industries.append(industries["edu"])
